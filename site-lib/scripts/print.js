(function () {
  ...
  function extractContent(doc) {
    ...
    var subtitle = doc.querySelector('.page-subtitle');
    if (title) html += title.outerHTML;
    if (subtitle) html += subtitle.outerHTML;
  ...
  window.downloadFolderPDF = async function (folderName) {
    ...
    win.document.write('<style>.theme-dark{--background-primary:#100e17;--background-primary-alt:#0d0b12;--background-secondary:#191621;--background-secondary-alt:#0d0b12;--text-normal:#bebebe;--text-accent:#0fb6d6;--text-sub-accent:#f4569d;--text-dim:#45aaff;--text-faint:#7aa2f7;--text-title-h1:var(--text-accent);--text-title-h2:#cbdbe5;--text-title-h3:#cbdbe5;--text-title-h4:#cbdbe5;--text-title-h5:#cbdbe5;--text-link:#b4b4b4;--text-a:#6bcafb;--text-a-hover:#6bcafb;--text-mark:#263d92;--code-background:var(--background-secondary);--interactive-accent:rgba(14, 210, 247, 0.5);--interactive-accent-hover:rgba(14, 210, 247, 0.8);--interactive-before:#5e6565;--blockquote-border:#4aa8fb;--tag-background:rgba(14, 210, 247, 0.15);--interactive-accent-rgb:#3dd7fb;--font-family-editor:\'Rubik\';--font-family-preview:\'Rubik\'}.theme-light{--background-primary:#ffffff;--background-primary-alt:#f5f5f5;--background-secondary:#f0f0f0;--background-secondary-alt:#e8e8e8;--text-normal:#1a1a2e;--text-accent:#0d6e8a;--text-sub-accent:#c23a6e;--text-dim:#2563eb;--text-faint:#4b5e8a;--text-title-h1:var(--text-accent);--text-title-h2:#1a1a2e;--text-title-h3:#1a1a2e;--text-title-h4:#1a1a2e;--text-title-h5:#1a1a2e;--text-link:#444444;--text-a:#0d6e8a;--text-a-hover:#0a5a72;--text-mark:#fff3cd;--code-background:var(--background-secondary);--interactive-accent:rgba(13, 110, 138, 0.5);--interactive-accent-hover:rgba(13, 110, 138, 0.8);--interactive-before:#cccccc;--blockquote-border:#0d6e8a;--tag-background:rgba(13, 110, 138, 0.12);--interactive-accent-rgb:13,110,138;--font-family-editor:\'Rubik\';--font-family-preview:\'Rubik\'}:root{--default-font:\'Rubik\',-apple-system,BlinkMacSystemFont,\'Segoe UI\',Roboto,Helvetica,Arial,sans-serif;--default-font-size:18px;--line-width:100%;--file-line-width:100%}body{font-family:\'Rubik\',\'Segoe UI\',Roboto,Arial,sans-serif;line-height:1.6;background:' + bgColor + ';color:' + textColor + '}[dir="rtl"] ul,[dir="rtl"] ol{padding-left:0!important;padding-right:1.5em!important}[dir="rtl"] li{text-align:right!important}.theme-light strong{color:var(--text-sub-accent);background:none!important;-webkit-background-clip:initial!important;-webkit-text-fill-color:initial!important}.theme-light em{color:var(--text-dim)}.theme-light code{color:var(--text-accent);background-color:var(--background-secondary)}.theme-light blockquote{border-left:4px solid var(--blockquote-border);background-color:var(--background-primary-alt);color:var(--text-normal)}[dir="rtl"] blockquote{border-left:none!important;border-right:4px solid var(--blockquote-border)!important}.page-title{margin-top:0;margin-bottom:0.2em}.page-subtitle{font-size:1.2em;color:var(--text-faint);margin-bottom:1.5em;border-bottom:1px solid var(--background-modifier-border);padding-bottom:0.5em}</style>');
    win.document.write('</head><body class="' + themeClass + ' show-inline-title" dir="rtl">');
